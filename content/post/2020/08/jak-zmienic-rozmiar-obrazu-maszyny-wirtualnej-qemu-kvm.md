...
![]({{< baseurl >}}/img/2020/08/052-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/053-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)

Wybieramy cd-rom (pozycja druga).

Po chwili powinien nam się załadować system live Ubuntu:

![]({{< baseurl >}}/img/2020/08/054-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/055-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/056-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)

![]({{< baseurl >}}/img/2020/08/057-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/058-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)

Gdy proces zmiany rozmiaru partycji się zakończy, powinniśmy mieć jedną mniejszą partycję oraz
sporo wolnego miejsca:

![]({{< baseurl >}}/img/2020/08/059-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/061-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)

Jak widać, nie mamy już żadnej wolnej przestrzeni, a systemowa partycja kończy się dokładnie na
20973567 sektorze:

![]({{< baseurl >}}/img/2020/08/062-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/081-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/082-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)

Po czym rozpoczynamy proces zwiększenia rozmiaru partycji:

![]({{< baseurl >}}/img/2020/08/083-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/084-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
![]({{< baseurl >}}/img/2020/08/063-virtualization-kvm-qemu-system-change-image-qcow2-size.png#huge)
...
[1]: {{< baseurl >}}/post/wirtualizacja-qemu-kvm-libvirt-na-debian-linux/
