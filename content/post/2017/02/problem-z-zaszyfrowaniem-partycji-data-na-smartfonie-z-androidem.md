...
![android-szyfrowanie-partycja-data-recovery-twrp-blad-data](/img/2017/02/001.android-szyfrowanie-partycja-data-recovery-twrp-blad-data.png#big)
...
![android-szyfrowanie-partycja-data-recovery-twrp-terminal](/img/2017/02/002.android-szyfrowanie-partycja-data-recovery-twrp-terminal.png#huge)

Sprawdzamy czy partycja `/data/` jest zamontowana. Jeśli tak, to trzeba ją odmontować:

![android-szyfrowanie-partycja-data-recovery-twrp-umount-data](/img/2017/02/003.android-szyfrowanie-partycja-data-recovery-twrp-umount-data.png#medium)

Skanujemy teraz system plików partycji `/data/` w poszukiwaniu ewentualnych błędów przy pomocy
narzędzia `e2fsck` :

![android-szyfrowanie-partycja-data-recovery-twrp-fsck-data](/img/2017/02/004.android-szyfrowanie-partycja-data-recovery-twrp-fsck-data.png#medium)

Teraz zmieniamy rozmiar tej partycji za sprawą `resize2fs` :

![android-szyfrowanie-partycja-data-recovery-twrp-resize-data](/img/2017/02/005.android-szyfrowanie-partycja-data-recovery-twrp-resize-data.png#medium)
...
![android-szyfrowanie-partycja-data-proces](/img/2017/02/006.android-szyfrowanie-partycja-data-proces.jpg#big)
