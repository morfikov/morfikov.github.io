...
![]({{< baseurl >}}/img/2016/09/2.aktualizacja-firmware-dd-wrt-flash.png)
...
![]({{< baseurl >}}/img/2016/09/3.aktualizacja-firmware-dd-wrt-proces.png)

Po pomyślnej aktualizacji firmware, router powinien się zresetować, a my zobaczyć poniższą
informację:

![]({{< baseurl >}}/img/2016/09/4.aktualizacja-firmware-dd-wrt-proces.png)
...
![]({{< baseurl >}}/img/2016/09/1.aktualizacja-firmware-dd-wrt-panel-admina.png)
...
![]({{< baseurl >}}/img/2016/09/5.dd-wrt-aktualizacja-firmware-terminal-telnet-ssh.png)
